...
COTask.COChannels.CreatePulseChannelFrequency('/Dev2/ctr0', 'COtask', COPulseFrequencyUnits.Hertz, COPulseIdleState.Low, 1, 1e4, 0.1 ); %delay, freq, dutycycle
...
CIch = CITask.CIChannels.CreatePulseWidthChannel('/Dev2/ctr2', 'CItask',0,2^32-1,CIPulseWidthStartingEdge.Rising,CIPulseWidthUnits.Ticks);
CIch.CounterTimebaseSource = '/Dev2/PFI'

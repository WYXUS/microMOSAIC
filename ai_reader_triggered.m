...
y = y + YCenter;
[X,Y] = meshgrid(x,y);
coordPoints = [repelem(X(:)*calibration,pixRep), repelem(Y(:)*calibration, pixRep)];
...
AItask.Triggers.StartTrigger.ConfigureDigitalEdgeTrigger('/Dev2/ao/StartTrigger',DigitalEdgeStartTriggerEdge.Rising);
...
AOwriter.WriteMultiSample(true,coordPoints');
